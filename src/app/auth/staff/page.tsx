    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl overflow-hidden">
        <div className="p-8 text-center bg-slate-900 text-white">
          ...
          <h1 className="mt-3 text-3xl font-semibold">Staff Panel</h1>
          <p className="mt-2 text-slate-300">Enter your login details to access the staff dashboard.</p>
        </div>
        ...
        <div className="p-8">
          ...
          <div className="mt-6 text-center text-sm text-slate-500">
            <p>
              Need admin login?{' '}
              <Link href="/auth/admin" className="font-semibold text-slate-900 hover:underline">
                Admin / Manager login
              </Link>
            </p>
          </div>
